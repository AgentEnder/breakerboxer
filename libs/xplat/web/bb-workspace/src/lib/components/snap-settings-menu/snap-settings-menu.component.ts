...
import { BreakerboxerActions, BreakerboxerState, compareSnapSettings } from '@tbs/xplat/base/breakerboxer-data';
...
export class SnapSettingsMenuComponent extends BaseComponent implements AfterViewInit {
    ...
    constructor(private fb: FormBuilder, private store: Store) {
        ...
        this.store.select(BreakerboxerState.selectSnapSettings).pipe(
            ...
            distinctUntilChanged(compareSnapSettings)
        ).subscribe(x => {
            this.fg.patchValue({
